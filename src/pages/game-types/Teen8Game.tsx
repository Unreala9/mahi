...
const Teen8Game = ({ game }: Teen8GameProps) => {
  ...
  if (!gameData && !loadingTimeout && !error) {
    return (
      <MainLayout>
        <div className="min-h-screen bg-gradient-to-br from-purple-950 via-gray-900 to-red-950 flex items-center justify-center">
  ...
  if (loadingTimeout || error) {
    return (
      <MainLayout>
        <div className="min-h-screen bg-gradient-to-br from-purple-950 via-gray-900 to-red-950 flex flex-col items-center justify-center gap-4 p-8">
