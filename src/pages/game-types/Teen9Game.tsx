...
const Teen9Game = ({ game }: Teen9GameProps) => {
  ...
  if (!gameData && !loadingTimeout && !error) {
    return (
      <MainLayout>
        <div className="min-h-screen bg-gradient-to-br from-blue-950 via-gray-900 to-cyan-950 flex items-center justify-center">
  ...
  if (loadingTimeout || error) {
    return (
      <MainLayout>
        <div className="min-h-screen bg-gradient-to-br from-blue-950 via-gray-900 to-cyan-950 flex flex-col items-center justify-center gap-4 p-8">
