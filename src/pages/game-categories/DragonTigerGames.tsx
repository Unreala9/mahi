/**
 * Dragon Tiger Games Category Page
 * Handles: dt20, dt6, dtl20, dt202
 */
...
export default function DragonTigerGames() {
  ...
  const renderCards = (cardString: string) => {
    ...
    // Dragon Tiger typically shows 2 cards: Dragon and Tiger
    return (
      <div className="flex gap-8 justify-center items-center">
        <div className="text-center">
          <Badge className="mb-2 bg-red-600">Dragon</Badge>
          <div className="w-20 h-28 bg-white rounded-lg border-2 border-red-500 flex items-center justify-center text-3xl font-bold shadow-lg">
            {cards[0] || "?"}
          </div>
        </div>
        <div className="text-4xl font-bold text-muted-foreground">VS</div>
        <div className="text-center">
          <Badge className="mb-2 bg-blue-600">Tiger</Badge>
          <div className="w-20 h-28 bg-white rounded-lg border-2 border-blue-500 flex items-center justify-center text-3xl font-bold shadow-lg">
            {cards[1] || "?"}
          </div>
        </div>
      </div>
    ...
    <div className="container mx-auto px-4 py-6 max-w-7xl">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          {/* Cards Display */}
          {gameData.card && (
            <Card className="p-8 bg-gradient-to-br from-purple-900 to-indigo-900">
