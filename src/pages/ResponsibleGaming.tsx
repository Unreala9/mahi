        ...
        <section className="relative py-12 overflow-hidden border-b border-border mb-12">
          <div className="text-center relative z-10">
            ...
            <p className="text-xl text-muted-foreground leading-relaxed max-w-2xl mx-auto">
              ...
              gaming environment. We believe gambling should be entertaining,
              not harmful. Here's how we help you stay in control.
            </p>
          </div>
        </section>
          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="space-y-6">
              <p className="text-lg text-muted-foreground text-center mb-8">
                If you feel you need a break from gaming, we offer
